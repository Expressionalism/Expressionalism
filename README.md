...
For more, visit expressionalism.com. Open for hacks, refinements, and contributions!
...
⦁	scripts/
⦁	expressionalism_toolkit.py: Python tool for running analyses (e.g., on "logical law of identity x=x").
Getting Started
Clone the Repo:  
text  
...
text  
python scripts/expressionalism_toolkit.py --input "The sky is blue due to Rayleigh scattering" --toggles Density_Probe=On  
...
Support this work? Buy me a coffee here. THANKS AGAIN!
